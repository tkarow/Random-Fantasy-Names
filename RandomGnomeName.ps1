...
#region The following arrays may be implemented in the future. Unsure.
$ForestFoods = @("apple","bean","beet","berry","bug","bun","butter","cake","candy","cherry","chive","cream","dill","dumpling","egg","fig","fruit","fungus","garlic","ginger","grub","gum","hazel","hemlock","honey","jam","jelly","leek","maple","melon","mint","mushroom","nettle","nut","onion","parsley","parsnip","pea","peach","pepper","plum","pumpkin","root","sap","seed","shroom","spice","soup","spud","sugar","syrup","tea","tater","truffle","turnip","waffle","water","wort")
$ForestLocales = @()
$ForestFluids = @("cider","dew","honey","juice","milk","nectar","pond","puddle","sap","tea","tonic","water")
#endregion
