...
$Prefixes = @("blink","rich")
$OneSyllableRoots = ("bib","big","bit","bob","bum","chit","cub","cup","did","dink","fib","flub","gig","glib","gum","hop","ingle","ink","jig","ken","ker","kin","kirk","link","lump","nab","nib","nip","nub","peck","pib","plump","plunk","pop","puff","riff","tiff","tink","tum","wig","wink")
$MultipleSyllableRoots = @("apple","bibble","bobbin","bumble","chibi","chin","diddy","dimple","dingle","dumble","giggle","gummy","hiccup","itchker","jelly","mingle","nipper","nibble","ninny","nimble","noggin","patter","pebble","pepper","piddle","pitter","riffle","rumple","scoot","silly","skip","sniff","sugar","thimble","tickle","tingle","tinkle","toddle","tom","trib","truffle","tumble","tummy","tummytum","wiggle","willy","winkle","wrinkle")
$Roots = @()
$Roots += $OneSyllableRoots
$Roots += $MultipleSyllableRoots
$Suffixes = @("abble","abbit","bee","belly","bit","bob","bin","bun","by","chatter","chitter","chub","dumpling","ibble","iggle","in","ing","inker","it","itcher","jenkin","ken","kin","knickers","let","lin","link","ling","lingur","nipper","ocky","perkin","piddle","pudding","nub","nubbin","rump","sby","shick","sip","tom","umpkin","wiff","wilkin","wiggle")
$Vowels = @("a","i")
...
$RockNouns = @("beard","bell","book","bottle","brass","button","candle","candy","cane","cap","cavern","chime","chip","clock","clog","coal","copper","craft","crystal","dingle","drip","fault","finger","fire","fizzle","flux","fumble","fungus","gear","gem","glimmer","glove","grub","hammer","hour","ink","jewel","key","lantern","law","ledger","lesson","letter","light","link","lock","lore","metal","mine","name","needle","nubbin","paper","pinky","pipe","print","quill","quiver","rock","ruby","ruin","rule","root","scuttle","seal","shoe","shovel","shroom","song","screw","soup","spell","spring","song","stamp","steam","stone","story","study","sugar","thimble","thorn","thread","thumb","time","toe","tome","tongue","tooth","tummy","tunnel","water","wax","wit","well","whistle","worm","wrench")
$RockAgents = @("belly","bender","berger","binder","biter","bits","breaker","brow","buffer","caster","catcher","chiller","chipper","climber","cooker","counter","crafter","cutter","digger","dinger","dripper","dropper","file","finder","fixer","giver","goggles","helmer","hemmer","heimer","hider","holder","home","hopper","-inker","-itcher","joker","judger","keeper","kicker","knocker","locker","lover","monch","picker","puffer","pocket","polish","prank","printer","puller","pusher","presser","mallow","maker","mender","miner","noggin","reader","rooter","scamp","sealer","seeker","setter","shaper","signer","sinker","snatcher","snipper","speaker","spinner","stamper","taster","teacher","teller","tender","thrower","tinker","tricker","tucker","twitcher","watcher","witcher","worker","writer")
$RockAdjectives = @("bad","brass","break","bright","candy","clean","clever","cold","copper","crackle","crafty","dark","deep","dizzy","double","dusty","fair","fault","frolic","funny","gem","gold","good","grumble","happy","hard","high","hot","inky","itchy","long","lost","loud","low","magic","naughty","noble","old","over","quick","rusty","short","silver","sly","soft","soot","spore","steady","sweet","tender","tiny","twitchy","under","tricksy","twinkle","warm","wee","wet","witty")
$RockFriends = @()
$RockTenders = @()

$ForestNouns = @("acorn","alder","apple","autumn","barb","bark","basket","bean","beard","bed","bee","beet","bell","belly","berry","birch","bloom","bobbin","bottle","bough","breeze","bubble","buckle","bud","bug","bulb","bur","bush","butter","button","candle","candy","cane","cap","cedar","cherry","chive","circle","cloud","clover","comb","conker","craft","critter","crystal","cup","day","dingle","dew","dill","dream","drip","dusk","dwale","earth","egg","elder","elm","fern","flower","field","fig","finger","fir","fizzle","forest","fruit","fumble","fungus","game","garden","garland","garlic","germ","ginger","glade","glove","grass","grub","harvest","hazel","hearth","hedge","hemlock","hive","holly","home","honey","horn","hunt","iris","ivy","jam","land","leaf","leek","light","lilly","litter","lore","magic","maple","marsh","meadow","melon","milk","mint","moon","morning","moss","mud","mushroom","needle","nest","nettle","night","nubbin","nut","oak","oath","onion","orchid","paddy","pansy","parsley","parsnip","patch","path","pea","peach","pepper","petal","pillow","pine","pinky","pipe","plum","pond","pot","prank","promise","prune","puddle","puff","pumpkin","rain","root","rose","sap","scuttle","seed","shade","shoe","shoot","shroom","shrub","sky","slug","snail","spice","song","soup","spell","splinter","spore","song","spell","sprig","spring","spud","spruce","stem","stone","story","sugar","summer","sun","star","stick","stream","stump","syrup","tater","tea","thimble","thistle","thorn","thread","timber","truffle","trunk","thumb","toe","tongue","tooth","tree","tuft","turnip","twig","vision","wall","water","wax","wind","wit","weed","well","whistle","willow","winter","wish","wisp","wode","wood","wort","yew")
$ForestAgents = @("belly","berry","biter","bits","brush","buzzer","caller","caster","catcher","chiller","climber","cooker","crafter","critter","dinger","dreamer","dropper","field","finder","fixer","flitter","flower","friend","friend","friend","giver","grower","heimer","helmer","hider","holder","home","hopper","hummer","hunter","-itcher","jelly","joker","juicer","keeper","knocker","knot","lover","mannin","monch","namer","picker","pocket","planter","player","plucker","prank","puffer","puller","pusher","maker","mallow","mender","noggin","patcher","ranger","rooter","sage","scamp","scratcher","seeker","seer","shaper","smoker","snatcher","speaker","splitter","spinner","stamper","stinger","stitcher","straw","taster","teacher","teller","tender","thrower","tinker","tracker","trapper","tricker","tucker","tumbler","tummy","twitcher","vine","wander","watcher","weaver","weeder","wicker","wisher","witcher","worker")
$ForestAdjectives = @("bad","break","bright","butter","candy","clean","clever","cold","cozy","crafty","dark","dizzy","double","early","fair","fey","frolic","funny","good","green","grumble","half","happy","hard","high","hot","humming","itchy","jelly","long","lost","loud","low","magic","muddy","naughty","nutty","oak","over","puff","quick","shady","short","silver","sly","soft","spore","steady","stink","sugar","sweet","tender","tiny","tricksy","twitchy","twinkle","warm","wee","wild","witty","wood")
$ForestFriends = @()
$ForestAnimals = @("ant","badger","beaver","bee","beetle","bird","bug","cricket","duck","fawn","ferret","fox","frog","goose","grub","hare","hedgehog","mouse","moth","newt","owl","rabbit","robin","slug","snail","sparrow","squirrel","swan","toad","woodpecker","worm")
...
$ForestFriends += $ForestAnimals
$ForestFriends += $ForestPlants
$ForestTenders = @()
